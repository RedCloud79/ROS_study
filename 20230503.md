...
int main (int argc, char** argv)
{
	...
	// 토픽은 ("my_topic")이며, 서브스크라이브큐(queue) 사이즈를 (100)으로 설정한다.
...
> 14. 다른 한 쪽창에 roserun topic_tutorial<패키지 이름> my_subscriber<노드 이름>
